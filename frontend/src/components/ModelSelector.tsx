    ...
    try {
      ...
      if (result.success && result.available) {
        setTestResult({
          ...
          } models.`, // This will be replaced by the animated message
        ...
        setTestResult({
          success: false,
          message:
            "❌ Service is reachable but not available. Check your configuration.",
        });
        ...
        if (
          ...
          errorMessage =
            "❌ Connection failed - Check your endpoint URL and network";
        } else if (errorMessage.includes("timeout")) {
          errorMessage =
            "❌ Connection timeout - Endpoint may be slow or unreachable";
        }
    ...
    try {
      ...
      if (result.success && result.available) {
        ...
        setTestResult({
          ...
          message: `Found ${
            result.models?.length || 0
          } models. Select which ones to enable.`,
          models: result.models || [],
        });
            ...
            models.map((model) => (
              ...
              >
                <div className="flex items-center space-x-3">
                  <Circle
                    className={`h-2 w-2 fill-current ${getStatusColor(model)}`}
                  />
                  <div className="flex flex-col">
                    ...
                    <div className="flex items-center space-x-2 text-xs text-muted-foreground">
                      ...
                      <span>•</span>
                      <span className={getStatusColor(model)}>
                        {getStatusText(model)}
                      </span>
                    </div>
                  </div>
      ...
      >
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Manage your LLM service endpoints and models. Ollama services will
              scan for available models, while OpenAI services require manual
              configuration.
            </DialogDescription>
          </DialogHeader>
                  ...
                  <Card>
                    <CardContent className="pt-6">
                      <p className="text-sm text-muted-foreground text-center">
                        No services configured yet. Switch to the &quot;Add New
                        Service&quot; tab to get started.
                      </p>
                    </CardContent>
                  </Card>
                ) : (
                      ...
                      <CardContent className="pt-0">
                        <div className="text-xs space-y-1">
                          ...
                          {service.type === "openai" && (
                            <div>
                              Endpoint:{" "}
                              {service.config.base_url || "Official OpenAI"}
                            </div>
                          )}
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex space-x-2">
                    <Button
                      type="button"
                      variant={
                        selectedServiceType === "ollama" ? "default" : "outline"
                      }
                      onClick={() => {
                        setSelectedServiceType("ollama");
                        setServiceConfig({
                    ...
                    <Button
                      type="button"
                      variant={
                        selectedServiceType === "openai" ? "default" : "outline"
                      }
                      onClick={() => {
                ...
                <div className="space-y-4">
                  ...
                  {selectedServiceType === "openai" && (
                    <>
                      <div className="space-y-2">
                        ...
                        />
                        <p className="text-xs text-muted-foreground">
                          Examples: DeepSeek: https://api.deepseek.com | Qwen:
                      ...
                      <div className="space-y-2">
                        ...
                        />
                        <p className="text-xs text-muted-foreground">
                          List the models available on your OpenAI-compatible
                          endpoint. For DeepSeek use:
                  ...
                  {discoveredModels.length > 0 && (
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Select which models you want to make available in the
                        app
                      </p>
                    </div>
                  )}
